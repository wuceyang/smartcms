    ...
    <div class="mainBox">
        ...
        <table border="0" align="center" cellpadding="8" cellspacing="0" class="tableBasic w90">
            <tr>
                ...
                <th width="120" align="center">栏目模板</th>
        ...
        <div id="addbox">
            <form method="post">
                <ul class="popContainer">
                    <li>
                        <label class="label">栏目名称:</label> <input name="name" class="inpMain" value="" type="text" width="50" /> <label class="tips">*栏目名称</label>
                    </li>
                    <li>
                    ...
                    <li>
                        <label class="label">排序顺序:</label> <input name="show_order" class="inpMain" value="" type="text" width="50" /> <label class="tips"> *当前栏目排序</label>
                    </li>
                </ul>
            </form>
        </div>
