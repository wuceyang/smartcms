	...
	class Image{
		...
		public function setImage($imagepath){
			...
			if(!file_exists($imagepath)) {
				...
				throw new Exception('找不到指定的图片文件:' . $imagepath);
			}
		...
		public function setFontFile($fontfile){
			...
			if(!file_exists($fontfile)) {
				...
				throw new Exception('找不到指定的字体文件:' . $fontfile);
			}
		...
		public function setVertical(bool $isVertical = false){
			
			$this -> strinfo['vertical'] = $isVertical;
		}

		public function setBold(bool $isBold = false){
			
			$this -> strinfo['bold'] = $isBold;
		}

		public function setItalic(bool $isItalic = false){
		...
		public function waterImage($waterImage){
			...
			if(!file_exists($waterImage)) {
				...
				throw new Exception('找不到指定的水印文件:' . $waterImage);
			}
		 ...
		 *@return array
		 */
		protected function getImageNewSize(int $dstw, int $dsth, int $orgw, int $orgh){
