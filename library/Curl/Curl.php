<?php
	...
	class Curl{
		...
		protected $_header 		= [];
		protected $_reqOptions  = []; //自定义Curl的头部
		...
		public function setRequestOption($reqOptions){
			$this->_reqOptions = $this->_reqOptions + $reqOptions;
		}
		...
		public function doRequest(){
			...
			if($this->_reqOptions){
				foreach ($this->_reqOptions as $k => $v) {
